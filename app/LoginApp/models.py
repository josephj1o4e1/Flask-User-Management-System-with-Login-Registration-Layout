...
class User(db.Model):
    ...
    def __init__(self, name, username, email, password, google_id=None, facebook_id=None, github_id=None, orcid_id=None, profile_pic=None, admin=False, is_confirmed=False, confirmed_on=None):
        self.name = name
